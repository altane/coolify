...
function generate_default_proxy_configuration(Server $server)
{
    ...
    if ($proxy_type === ProxyTypes::TRAEFIK->value) {
        $resolver = env("CERT_RESOLVER", "letsencrypt");
        $labels = [
            'traefik.enable=true',
            ...
            'services' => [
                'traefik' => [
                    ...
                    'command' => [
                        ...
                        '--entryPoints.websecure.http2.maxConcurrentStreams=50',
                        '--providers.docker.exposedbydefault=false',
                        '--providers.file.directory=/traefik/dynamic/',
                        '--providers.file.watch=true',
                        "--certificatesresolvers.{$resolver}.acme.httpchallenge=true",
                        "--certificatesresolvers.{$resolver}.acme.storage=/traefik/acme.json",
